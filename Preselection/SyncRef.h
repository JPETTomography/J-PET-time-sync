...
#ifndef _____TIME___SYNC_____REF____TASK_________ 
#       define _____TIME___SYNC_____REF____TASK_________
#include <memory>
...
class JPetWriter;
class TaskSyncRef:public JPetTask {
public:
  TaskSyncRef(const char * name, const char * description);

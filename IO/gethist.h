...
MathTemplates::hist<double> ReadHist(const std::string&filename,const std::string&histname);
MathTemplates::hist<double> ReadHist(const std::vector<std::string>&filenames,const std::string&histname);
#endif